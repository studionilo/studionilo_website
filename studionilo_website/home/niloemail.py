...
class NiloEmail:
    ...
    def __message(self):
        if(self.payIntent.plan == PaymentIntent.VIDEOREPORT):
            return render_to_string('home/email_video_report.html')
        elif(self.payIntent.plan == PaymentIntent.VIDEOCOLLOQUIO):
            return render_to_string('home/email_video_colloquio.html')
        else:
            return render_to_string('home/email_media_managing.html')
